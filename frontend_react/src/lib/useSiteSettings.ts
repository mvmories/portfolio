 ...
 * page to look right.
 */
export const FALLBACK_SETTINGS: Required<Pick<SiteSettings, 'cvEnabled' | 'cvUrl' | 'socials'>> = {
  cvEnabled: true,
...
const QUERY = `*[_id == "siteSettings"][0]{ cvEnabled, cvUrl, cvLabel, cvUpdatedAt, socials }`
